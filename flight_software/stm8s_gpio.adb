...
S:Lstm8s_gpio.GPIO_Init$GPIO_Mode$1_0$359({1}SC:U),B,1,2
S:Lstm8s_gpio.GPIO_Init$GPIO_Pin$1_0$0({1}SC:U),B,1,-3
S:Lstm8s_gpio.GPIO_Init$GPIOx$1_0$0({2}DG,STGPIO_struct:S),B,1,-2
S:Lstm8s_gpio.GPIO_Init$sloc0$0_1$0({2}DG,SC:U),B,1,-6
S:Lstm8s_gpio.GPIO_Init$sloc1$0_1$0({1}SC:U),B,1,-4
...
F:G$GPIO_ExternalPullUpConfig$0_0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lstm8s_gpio.GPIO_ExternalPullUpConfig$NewState$1_0$383({1}:S),B,1,2
S:Lstm8s_gpio.GPIO_ExternalPullUpConfig$GPIO_Pin$1_0$0({1}SC:U),R,0,0,[a]
S:Lstm8s_gpio.GPIO_ExternalPullUpConfig$GPIOx$1_0$0({2}DG,STGPIO_struct:S),B,1,-2
S:Lstm8s_gpio.GPIO_ExternalPullUpConfig$sloc0$0_1$0({1}SC:U),B,1,-3
...
T:Fstm8s_gpio$ADC2_struct[({0}S:S$CSR$0_0$0({1}SC:U),Z,0,0)({1}S:S$CR1$0_0$0({1}SC:U),Z,0,0)({2}S:S$CR2$0_0$0({1}SC:U),Z,0,0)({3}S:S$RESERVED$0_0$0({1}SC:U),Z,0,0)({4}S:S$DRH$0_0$0({1}SC:U),Z,0,0)({5}S:S$DRL$0_0$0({1}SC:U),Z,0,0)({6}S:S$TDRH$0_0$0({1}SC:U),Z,0,0)({7}S:S$TDRL$0_0$0({1}SC:U),Z,0,0)]
...
S:Fstm8s_gpio$__str_0$0_0$0({40}DA40d,SC:U),D,0,0
